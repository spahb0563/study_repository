...
public class OrderDetailSample extends StudyApplicationTests {
    ...
    private void item(User user){
        ...
        OrderGroup orderGroup = OrderGroup.builder()
                .user(user)
                .status(OrderGroupStatus.valueOf(status.toString()))
                .orderType(type)
        ...
        for(Item item : items){
            ...
            OrderDetail orderDetail = OrderDetail.builder()
                    ...
                    .item(item)
                    .arrivalDate(type.toString().equals(OrderType.ALL) ? orderGroup.getArrivalDate() : getRandomDate())
                    .status(type.toString().equals(OrderType.ALL) ? status : orderDetailStatus)
                    .build();
